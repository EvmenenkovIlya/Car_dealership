  ...
  <footer>
    ...
    <div className="footer-container">
      <div className="footer-block">
        <div className="block-head">
          ...
          <FooterLink url="map" text="Карта сайта" />
        </div>
      ...
      <div className="footer-block">
        ...
        <FooterInfo src={time} text="Ежедневно с 08:00 до 21:00" />
        <FooterInfo src={map} text="Россия, Москва, 38КМ МКАД, 6Бс1" />
    ...
    <div className="info">
      ...
      <p>
        ...
        <br /> определяемой положениями Статьи 437 Гражданского кодекса Российской Федерации.
      </p>
      <a href="yandex.ru">
        <img src={rating} alt="" />
      </a>
